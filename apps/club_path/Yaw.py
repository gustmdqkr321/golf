...
def compute_yaw_angles(xlsx_path: Path) -> list[float]:
    ...
    for n in range(1, 11):
        ...
        yaw = math.degrees(math.atan2(dz, math.sqrt(dx*dx + dy*dy)))
        yaws.append(yaw)

    return yaws

if __name__ == '__main__':
    # 테스트용 경로를 실제 파일 경로로 수정하세요
